  ...
  return (
    <div>
      <div className="card card-compact w-auto max-w-[24rem] bg-violet-700/[.5] shadow-xl">
        ...
        <div className="card-body xl:h-80">
          <h2 className="mt-4 text-white text-2xl font-semibold">{probs.project.name}</h2>
          <p className="mt-2 text-base text-justify">{probs.project.description}</p>
